...
import { ITest, ResultStatusEnum } from "@/entities/test";
...
export const TestRecCard: React.FC<TestCardProps> = ({ test, courseData }) => {
        ...
        <Stack gap={4}>
          ...
          <VisibleForRole role={UserRoleEnum.Student}>
            ...
            >
              ...
              {test.result.progress ? test.result.progress + "%" : undefined}
            </Badge>
          </VisibleForRole>
        </Stack>
